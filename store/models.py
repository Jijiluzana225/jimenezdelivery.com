...
class Item(models.Model):
    product = models.OneToOneField(Product, related_name='items', on_delete=models.CASCADE)
    store = models.OneToOneField(Store, related_name='items', on_delete=models.CASCADE)
    description = models.TextField(null=True, blank=True)
